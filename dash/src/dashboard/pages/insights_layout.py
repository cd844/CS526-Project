...
layout = html.Div([
        ...
        html.H5('''This is a languages vs its Count  plot, that shows how frequently each programming languages are used in the projects/ repositories. Javascript is one of the most used languages in most of the repositories followed by CSS.'''),
        ...
        html.H5(''' The plot above is a languages vs watcher’s count scatter plot that shows how frequently a certain repository that had the above-mentioned language as the highest contributor were viewed. This reflects how  popular a repository is for that particular language. It can be noticed how a repository that made use of c++ the most has the highest watcher’s count followed by JS. This also shows the distribution based on the popularity of each language'''),
        dcc.Graph(id = 'scatter-lang-vs-fork'),
        html.H5('''The bar plot about compares how frequently the above-mentioned topic repository was created. It shows that python containing projects were created more than others.
        '''),
        dcc.Graph(id = 'bar-topics-vs-count'),
        html.H5(''' The languages vs fork_count compares which repositories were interesting based on how frequently they were forked owing to their importance. Repositories in python, JS and Java have been forked more frequently as compared to others. 
        '''),
